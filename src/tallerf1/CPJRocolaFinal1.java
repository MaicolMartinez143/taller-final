...
public class CPJRocolaFinal1 extends javax.swing.JFrame {
 ...
 private Cancion cancion;
   ...
   String titulo = txtTitulo.getText(); // Obtener el título de la canción del campo de texto
        Cancion cancion = rocola.buscarCancion(titulo); // Buscar la canción en la rocola

        if (cancion != null) {
            cancion.reproducir(); // Llamar al método reproducir de la canción
           Resultado.setText( "Reproduciendo: " + cancion.getTitulo() + "\n" + "Reproducciones: " + cancion.contadorReproducciones);
        } else {
